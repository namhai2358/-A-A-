...
#### CÁC DẠNG
- - -
### Bài 1: Biểu thức chính quy là gì?<!-- {"fold":true} -->
...
### Bài 3: Tính lặp của tập ký tự mẫu trong biểu<!-- {"fold":true} -->
thức chính quy
...
hợp
### [[Bài 4: Ðịnh vị chuổi ký tự mẫu trong biểu thức<!-- {"fold":true} -->
chính quy
...
`/^[A-Za-z0-9_\.]{6,32}$/`
### Bài 5: Nhóm và lựa chọn một trong những<!-- {"fold":true} -->
...
rõ ràng dễ quản lý
### Bài 6: Các ký tự viết tắt trong biểu thức chính<!-- {"fold":true} -->
quy
...
>  `[A-Z], [a-z], [0-9]`
### Bài 7: Kiểm tra địa chỉ Email trong PHP bằng<!-- {"fold":true} -->
biểu thức chính quy
...
### Bài 8: Kiểm tra định dạng Username trong<!-- {"fold":true} -->
